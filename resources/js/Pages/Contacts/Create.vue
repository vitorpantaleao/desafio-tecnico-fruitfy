<template>
  <Head title="Novo Contato - Criar Contato" />
          ...
          <div class="px-6 py-8">
            <div class="flex justify-between items-center mb-8">
              <div>
                ...
                <p class="mt-2 text-gray-600">Preencha as informações para criar um novo contato</p>
              </div>
            ...
            <form @submit.prevent="submit" class="space-y-6">
              ...
              <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <AppButton
                  ...
                  :icon="CheckIcon"
                >
                  {{ form.processing ? 'Criando...' : 'Criar Contato' }}
                </AppButton>
              </div>
            </form>
          </div>
...
const submit = () => {
  form.post(route('contacts.store'), {
    onSuccess: () => {
      ...
      router.visit(route('contacts.index') + '?created=true')
    },
    onError: () => {
